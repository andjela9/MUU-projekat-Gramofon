...
void main(void){
	...
	//TODO za mod1: fali samo ispis
	if(start == 1 && mod == 1){	 			//broji nitne i meri vreme

		TH1 = 0xEE;
		TL1 = 0;				//startovan tajmer jer radi i u modu1 je
	...
	//TODO za mod2: kako poslati komandu? + ispis
	else if (start == 1 && mod == 2){		//implementacija za mod 2
		
		//poslati komandu koliko nitni treba
		TH1 = 0xEE;
		TL1 = 0;				//startovan tajmer jer radi i u modu2 je
